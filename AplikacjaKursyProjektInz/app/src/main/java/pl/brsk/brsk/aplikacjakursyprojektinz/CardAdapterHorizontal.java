...
public class CardAdapterHorizontal extends RecyclerView.Adapter<CardAdapterHorizontal.ViewHolder> {
    ...
    public CardAdapterHorizontal(List<Kurs> kursy, Context context){
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.kursy_list_horizontal, parent, false);
