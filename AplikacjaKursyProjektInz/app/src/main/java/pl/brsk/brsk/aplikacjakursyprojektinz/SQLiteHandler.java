...
public class SQLiteHandler extends SQLiteOpenHelper {
     ...
     * */
    public void addUser(String user_id, String name, String email, String uid, String created) {
        ...
        values.put(KEY_CREATED_AT, created); // Created At
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0) {
            ...
            user.put("created", cursor.getString(4));
        }
        cursor.close();
        db.close();
        // return user
